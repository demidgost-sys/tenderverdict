...
> turns each notice into a human next step: open, verify, or skip.

## 02 · Local workflow · 00:10–00:23

Target spoken length: **about 11.5 seconds**. Precise and reassuring. Pause after “Mac”.

> The workflow begins with committed synthetic profiles and normalized notice metadata. Files stay
...
> RevenueCat CustomerInfo then activated supplier profiles plus. It was not an App Store payment.
...
> For the current evaluation build, RevenueCat Judge Access grants the same entitlement without a
> purchase. Current refresh unlocked the screen. Restore access, foreground return, and a full
> process relaunch all preserved the CustomerInfo entitlement.
...
> open-source Apache two point zero software for macOS.

## Pronunciation block

Practice this section before recording; do not include it in a take.
