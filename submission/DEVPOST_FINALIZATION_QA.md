...
## Public media readback

- Current video: `https://www.youtube.com/watch?v=HFBtMsN7Nlk`
- Local v2 master SHA-256:
  `5862094c00c8dcb5e2e793d46d1ced44a003458dfcb1d957484135da13c6d047`
- Readback: `109` seconds, Unlisted, English subtitles published, unauthenticated oEmbed HTTP 200.
- Authenticated Studio reports the v2 source filename; the owner completed the normal-speed
...
- required icon and screenshot attached;
- macOS selected as the app type;
- public competition repository saved;
- qualifying academic-email and RevenueCat-project fields populated without copying their values
  into public evidence;
- employee/sponsor participation set to false;
- store release set to false;
- optional promo/reviewer-code field left blank;
