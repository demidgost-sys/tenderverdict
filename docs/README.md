...
and pending final-package work. Written organizer answers confirm the narrow Test Store-only path
and macOS eligibility; the [evidence record](SHIPATON_EVIDENCE.md) owns those primary sources and the
remaining personal/submission gates.
